            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/image.ImageUpdateRequest"
                        }
                    }
                ],
                "responses": {
    ...
    "definitions": {
        ...
        "models.ArticleModel": {
            ...
            "properties": {
                ...
                "banner_id": {
                    "description": "--------文章 belongs to 封面--------",
                    "type": "integer"
                },
                "banner_url": {
                    "description": "文章封面（不是冗余，用空间换时间，节省查找的时间）",
                    "type": "string"
                },
                "category": {
                    "description": "文章分类",
                ...
                "content": {
                    "description": "文章内容（在list场景中，过滤掉content字段）",
                    "type": "string"
                },
                "created_at": {
                    "description": "创建时间",
                ...
                "keyword": {
                    "description": "文章关键字（在list场景中，过滤掉keyword字段）",
                    "type": "string"
                },
                "link": {
                    "description": "原文链接",
                ...
                "user_avatar": {
                    "description": "文章作者头像（不是冗余，用空间换时间，节省查找的时间）",
                    "type": "string"
                },
                "user_id": {
                    "description": "--------用户 一对多 文章--------",
                    "type": "integer"
                },
                "user_nick_name": {
                    "description": "文章作者（不是冗余，用空间换时间，节省查找的时间）",
                    "type": "string"
                }
            }
        },
        ...
        "models.CommentModel": {
            ...
            "properties": {
                ...
                "parent_comment_id": {
                    "description": "--------子评论 belongs to 父评论--------",
                    "type": "integer"
                },
                "select(c)": {
