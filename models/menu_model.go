...
type MenuModel struct {
	...
	Abstract     ctype.Array `gorm:"type:string;comment:简介，按照换行去切割为数组" json:"abstract"` // 简介
	...
	BannerTime int `gorm:"comment:banner图的切换时间" json:"banner_time"` // banner图的切换时间，为0表示不切换
